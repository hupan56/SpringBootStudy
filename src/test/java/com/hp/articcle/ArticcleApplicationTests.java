...
//        field.add("生活");
        ...
        source.add("《求是》");//        System.out.println(page.getRecords());
...
//
//        System.out.println(opam.getArticlesBySource(page,"人民日报").getRecords());
//        System.out.println(opai.getAllByArticleTitleAndArticleSource("在庆祝香港回归祖国二十五周年大会暨香港特别行政区第六届政府就职典礼上的讲话",
//                "人民网－人民日报"));
        System.out.println(opai.updateById(article));

    }

    @Test
    void getAdminById(){
        System.out.println(opai.getAdminById(1));
    }

    @Test
    void getAdminNameById(){
        System.out.println(opai.getAdminNameById(1));
    }
    @Test
    void getAdminByName(){
        System.out.println(opai.getAdminByName("胡攀"));
    }
